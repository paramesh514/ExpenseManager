...
/*public class Budget {
    ...
    public Budget(int periodNameStyle, Calendar startDate, Calendar endDate, BigDecimal creditLimit) {
    ...
    public Budget(int id, int periodNameStyle, Calendar startDate, Calendar endDate, BigDecimal creditLimit) {
        this(periodNameStyle, startDate, endDate, creditLimit);

        this.id = id;
    }

    public Budget(int id, int periodNameStyle, Calendar startDate, Calendar endDate, BigDecimal creditLimit, List<Expense> expenses, List<Payment> payments) {
