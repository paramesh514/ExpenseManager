...
public class TransactionViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
    ...
    private TransactionDeletedListener mListener = null;
    ...
    public void setData(TransactionAdapter adapter, Fragment fragment, Transaction current, int creditPeriodId, int position) {
        mAdapter = adapter;
        mFragment = fragment;
       ...
       // ((GradientDrawable)this.mCategory.getBackground()).setColor(ContextCompat.getColor(mFragment.getContext(), current.getTransactionCategory().getColor()));
        ...
        //((GradientDrawable)this.mType.getBackground()).setColor(ContextCompat.getColor(mFragment.getContext(), current.getTransactionType().getColor()));
    ...
    public void setOnExpenseDeletedListener(TransactionDeletedListener listener) {
        mListener = listener;
    }
            ...
            case R.id.list_item_expenses_img_delete:
                ...
                DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                            mListener.OnTransactionDeleted(mExpensePosition);
                    }
                };
    ...
    public interface TransactionDeletedListener {
        void OnTransactionDeleted(int position);
    }
}
