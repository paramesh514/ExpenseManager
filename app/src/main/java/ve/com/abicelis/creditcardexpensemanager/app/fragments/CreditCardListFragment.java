...
public class CreditCardListFragment extends Fragment {
    ...
    private void showEditOrDeleteCCDialog(Account selectedCreditCard) {
        FragmentManager fm = getFragmentManager();
        EditOrDeleteAccountDialogFragment dialog = EditOrDeleteAccountDialogFragment.newInstance(
                dao,
                selectedCreditCard);
